...
function t10() {
  document.querySelector(".out-10").textContent =
    document.querySelector(".i-10").value * 20;
}
...
function t11() {
  ...
  document.querySelector(".out-11").textContent = a += 55;
}
...
function t12() {
  const name = document.querySelector(".i-12-1").value;
  const surname = document.querySelector(".i-12-2").value;
